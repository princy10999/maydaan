...
class ViewAttendance extends Component {
  ...
  componentDidMount() {
    ...
    document.title = "Maydaan | View Attendance";
  }
              ...
              <div className="row">
                ...
                <div className="col-lg-9 col-md-12 col-sm-12 rpr-0">
                  <div className="dasbordRightlink">
                    ...
                    <h1>{this.state.trainer?`View Attendance (${this.state.trainer.first_name} ${this.state.trainer.last_name})`:null}</h1>
...
export default connect(null, mapDispatchToProps)(ViewAttendance);
